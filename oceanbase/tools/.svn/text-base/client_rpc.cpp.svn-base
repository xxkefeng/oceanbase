...
int ObClientRpcStub::ups_scan(const ObScanParam& scan_param, ObNewScanner& scanner)
{
  return send_1_return_1(remote_server_, DEFAULT_TIMEOUT, OB_NEW_SCAN_REQUEST, DEFAULT_VERSION, scan_param, scanner);
}
...
int ObClientRpcStub::cs_stop_build_index()
{
  return send_0_return_0(remote_server_, DEFAULT_TIMEOUT, OB_CS_STOP_BUILD_INDEX, DEFAULT_VERSION);
}
...
{
  return send_2_return_1(remote_server_, DEFAULT_TIMEOUT, OB_FETCH_SCHEMA, 2, version, only_core_tables, schema);
}
...
int ObClientRpcStub::cs_sql_scan(const oceanbase::sql::ObSqlScanParam & scan_param, oceanbase::common::ObNewScanner& scanner)
{
  return send_1_return_1(remote_server_, DEFAULT_TIMEOUT, OB_SQL_SCAN_REQUEST, DEFAULT_VERSION, scan_param, scanner);
}

int ObClientRpcStub::cs_sql_get(const oceanbase::sql::ObSqlGetParam& get_param, oceanbase::common::ObNewScanner& scanner)
{
  return send_1_return_1(remote_server_, DEFAULT_TIMEOUT, OB_SQL_GET_REQUEST, DEFAULT_VERSION, get_param, scanner);
}

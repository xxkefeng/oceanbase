...
class GFactory
{
  public:
    ...
    inline chunkserver::ObSqlRpcStub &get_sql_rpc_stub() { return sql_rpc_stub_; }
    inline const common::ObServer &get_chunk_server() { return chunk_server_; }
  ...
  private:
    ...
    common::ThreadSpecificBuffer sql_rpc_buffer_;;

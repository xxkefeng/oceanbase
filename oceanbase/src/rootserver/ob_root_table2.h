  ...
  namespace rootserver
  {
    ...
    class ObRootTable2
    {
      ...
      public:
        ...
        int get_table_tablet_info(const uint64_t table_id, int64_t& tablet_count, 
        ...
        void dump() const;
        void dump(common::ObNewScanner &scanner, const ObChunkServerManager &cs_mgr) const;
        ...
        int create_table(const common::ObTabletInfo& tablet, const common::ObArray<int32_t> &chunkservers, const int64_t tablet_version, bool cs_create = true);
        bool add_lost_range();
        ...
        bool check_table_all_tablets_available(const uint64_t table_id);
        void sort();

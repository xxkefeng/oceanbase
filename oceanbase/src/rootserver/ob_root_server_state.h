  ...
  namespace rootserver
  {
    ...
    class ObRootServerState
    {
      ...
      public:
        ...
        inline void set_check_and_delete_flag()
        {
          check_and_delete_flag_ = true;
        }
        inline void clean_flag()
        {
          TBSYS_LOG(INFO, "clean root_server state. set check_and_delete_flag and tablet_merge_flag false");
          check_and_delete_flag_ = false;
          tablet_merge_flag_ = false;
        }
        ...
        inline void set_tablet_merge_flag(const bool flag)
        {
          TBSYS_LOG(INFO, "set tablet merge flag %s", flag ? "true": "false");
          tablet_merge_flag_ = flag;
        }
        inline bool get_tablet_merge_flag() const
        {
          return tablet_merge_flag_;
        }
        inline void set_bypass_flag(const bool flag)
        {
        ...
        inline bool is_ready_for_delete() const
        {
        ...
        inline void set_state(const State state)
        {
          ...
          TBSYS_LOG(INFO, "set_state=%s", get_state_str());
        }

 ...
 *
 */
#ifndef OCEANBASE_SSTABLE_NONCG_SCANNER_V2_H
#define OCEANBASE_SSTABLE_NONCG_SCANNER_V2_H
    ...
    class ObNoncgSSTableScanner : public ObRowIterator
    {
      ...
      private:
        ...
        int build_all_column_index( const uint64_t table_id, 
            const sstable::ObSSTableSchema& schema);
        ...
        int consummate_row_desc(const sstable::ObSSTableReader *sstable_reader);
        ...
        int initialize(const sstable::ObSSTableScanParam *param, const ScanContext *scan_context);
        ...
        int build_empty_sstable_row_desc(const sstable::ObSSTableScanParam& scan_param);
        bool is_empty_sstable(const int64_t table_id, const sstable::ObSSTableReader *reader) const;

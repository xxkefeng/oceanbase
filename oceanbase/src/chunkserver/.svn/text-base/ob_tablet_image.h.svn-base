  ...
  namespace chunkserver
  {
    ...
    class ObTabletImage
    {
      ...
      public:
        ...
        friend class TestTabletLogWorker;
      ...
      public:
        ...
        void set_log_worker(ObChunkLogWorker* log_worker);
      ...
      public:
         ...
         * disk by direct io
         */
        int prepare_write_meta(const int32_t disk_no, int64_t* size = NULL);
        int write_meta(const char* idx_path, const int32_t disk_no);
        int write_meta(const char* data, const int64_t data_len, const char* idx_path, const int32_t disk_no);
    ...
    class ObMultiVersionTabletImage 
    {
      ...
      public:
        ...
        ObMultiVersionTabletImage(common::IFileInfoMgr& fileinfo_cache,
          ObDiskManager& disk_manager, ObChunkLogWorker* log_work, ObChunkLogManager* log_manager);
      ...
      public:
         ...
         *@param version if > 0, then search the tablet start from the eldest version which
         *version equal the version, else return ENTRY_NOT_EXIST, if version = 0, then
         *search the versoin start from the newest version, if not found, then search in old version
        ...
        /**
          * flush the redo log from buffer to disk
          */
        int flush_log(common::LogCommand cmd, bool flush = true);

        /**
         * set the merged flag and log the change into log_buf
         */
        int set_tablet_merged(ObTablet* tablet, const int status = 1);

        /**
         * release tablet, subtract ref count.
         */
        int release_tablet(ObTablet* tablet, bool remove_sstable = true) const;
        ...
        /**
         * update the to_merge_index and last_not_merge_data_version
         */
        int finish_merge();
        ...
        int64_t get_last_not_merged_version() const;
        ...
        inline const ObTabletImage & get_last_not_merged_image() const
        {
          return get_image(get_last_not_merged_version());
        }
      ...
      private:
        int write(const char* data, const int64_t data_len, const int64_t version, const int32_t disk_no);
        int copy_meta_to_buf(common::ObBufferWriter* const wbuf);
      ...
      private:
        ...
        int64_t last_not_merged_index_;

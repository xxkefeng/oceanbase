...
int ObExtraTablesSchema::first_tablet_entry_schema(TableSchema& table_schema)
{
  ...
  // @TODO
  table_schema.max_used_column_id_ = first_tablet_entry_cid::INDEX_STATUS_ID;
  ...
  table_schema.charset_number_ = OB_DEFAULT_CHARACTER_SET; //GBK
  ...
  ADD_COLUMN_SCHEMA("tablet_block_size", //column_name
      ...
      sizeof(int64_t), //column length
      false); //is nullable
  ADD_COLUMN_SCHEMA("character_set", //column_name
      first_tablet_entry_cid::CHARACTER_SET_ID, //column_id
      0, //rowkey_id
      ObIntType,  //column_type
      sizeof(int64_t), //column length
      false); //is nullable
  ADD_COLUMN_SCHEMA("data_table_id", //column_name
      first_tablet_entry_cid::DATA_TABLE_ID_ID, //column_id
      0, //rowkey_id
      ObIntType,  //column_type
      sizeof(int64_t), //column length
      true); //is nullable
  ADD_COLUMN_SCHEMA("index_status", //column_name
      first_tablet_entry_cid::INDEX_STATUS_ID, //column_id
      0, //rowkey_id
      ObIntType,  //column_type
      sizeof(int64_t), //column length
      true); //is nullable
...
int ObExtraTablesSchema::root_table_schema(TableSchema & table_schema)
{
  int ret = OB_SUCCESS;

  table_schema.init_as_inner_table();
  strcpy(table_schema.table_name_, OB_ROOT_TABLE_TABLE_NAME);
  table_schema.table_id_ = OB_ROOT_TABLE_TID;
  ...
  ADD_COLUMN_SCHEMA("end_key", //column_name
      ...
      10*1024, //column length
      false); //is nullable
  ADD_COLUMN_SCHEMA("static_row_count", //column_name
      column_id ++, //column_id
      0, //rowkey end
      ObIntType,  //column_type
      sizeof(int64_t), //column length
  ...
  ADD_COLUMN_SCHEMA("occupy_size", //column_name
      ...
      sizeof(int64_t), //column length
      true); //is nullable
  ADD_COLUMN_SCHEMA("crc", //column_name
      column_id ++, //column_id
      0, //rowkey end
      ObIntType,  //column_type
      sizeof(int64_t), //column length
      true); //is nullable
  ADD_COLUMN_SCHEMA("replica_1", //column_name
      column_id ++, //column_id
      0, // not rowkey
      ObVarcharType,  //column_type
      OB_IP_STR_BUFF, //column length
      true); //is nullable
   ADD_COLUMN_SCHEMA("replica_2", //column_name
      column_id ++, //column_id
      0, //not rowkey
      ObVarcharType,  //column_type
      OB_IP_STR_BUFF, //column length
      true); //is nullable
   ADD_COLUMN_SCHEMA("replica_3", //column_name
      column_id ++, //column_id
      0, //not rowkey
      ObVarcharType,  //column_type
      OB_IP_STR_BUFF, //column length

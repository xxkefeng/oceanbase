...
namespace oceanbase
{
  namespace common
  {
    enum PacketCode
    {
      ...
      OB_CS_SAMPLE_TABLE = 241,
      OB_CS_SAMPLE_TABLE_RESPONSE = 242,
      OB_CS_REPORT_SAMPLES = 243,
      OB_CS_REPORT_SAMPLES_RESPONSE = 244,
      OB_CS_SAMPLE_TABLE_DONE = 245,
      OB_CS_SAMPLE_TABLE_DONE_RESPONSE = 246,
      OB_CS_BUILD_INDEX = 247,
      OB_CS_BUILD_INDEX_RESPONSE = 248,
      OB_CS_BUILD_INDEX_DONE = 249,
      OB_CS_BUILD_INDEX_DONE_RESPONSE = 250,
      OB_CS_DISK_MAINTAIN = 251,
      OB_CS_DISK_MAINTAIN_RESPONSE = 252,
      OB_CS_STOP_BUILD_INDEX = 253,
      OB_CS_STOP_BUILD_INDEX_RESPONSE = 254,
      ...
      OB_SSTABLE_SCAN_REQUEST = 436,
      OB_SSTABLE_SCAN_RESPONSE = 437,
      ...
      OB_RS_INNER_MSG_CHECK_LOAD_PROCSS = 3007,

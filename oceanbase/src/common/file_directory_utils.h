...
# define S_IRWXUGO (S_IRWXU | S_IRWXG | S_IRWXO)
    ...
    class FileDirectoryUtils
    {
      public:
        ...
        // Generate a unique temporary filename (stored in %tmpfile) in %dir with %prefix.
        // Caller's responsibility to make sure %dir exists, we don't check it.
        static bool gen_tmpfile_name(char *tmpfile, const int64_t tmpfile_len,

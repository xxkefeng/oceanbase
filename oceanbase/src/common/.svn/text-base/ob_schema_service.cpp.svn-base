...
DEFINE_SERIALIZE(TableSchema)
{
  ...
  else if (OB_SUCCESS != (ret = serialization::encode_vi32(buf, buf_len, pos, charset_number_)))
  {
  ...
  else if (OB_SUCCESS != (ret = serialization::encode_vi64(buf, buf_len, pos, data_table_id_)))
  {
  }
  else if (OB_SUCCESS != (ret = serialization::encode_vi64(buf, buf_len, pos, index_status_)))
  {
  }
...
DEFINE_DESERIALIZE(TableSchema)
{
  ...
  else if (OB_SUCCESS != (ret = serialization::decode_vi32(buf, data_len, pos, &charset_number_)))
  {
    TBSYS_LOG(WARN, "deserialize error here");
  }
  ...
  else if (OB_SUCCESS != (ret = serialization::decode_vi64(buf, data_len, pos, reinterpret_cast<int64_t*>(&data_table_id_))))
  {
    TBSYS_LOG(WARN, "deserialize error here");
  }
  else if (OB_SUCCESS != (ret = serialization::decode_vi64(buf, data_len, pos, reinterpret_cast<int64_t*>(&index_status_))))
  {
    TBSYS_LOG(WARN, "deserialize error here");
  }

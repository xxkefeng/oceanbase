...
namespace oceanbase
{
  namespace common
  {
    ...
    {
      TSI_COMPACTSSTABLEV2_FILE_BUFFER_1 = 9001,
      TSI_COMPACTSSTABLEV2_FILE_BUFFER_2 = 9002,
      TSI_COMPACTSSTABLEV2_THREAD_AIO_BUFFER_MGR_ARRAY_1 = 9003,
    };

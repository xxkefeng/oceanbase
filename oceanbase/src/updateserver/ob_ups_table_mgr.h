  ...
  namespace updateserver
  {
    ...
    class ObUpsTableMgr : public ObIUpsTableMgr
    {
      ...
      public:
        ...
        int new_get(const common::ObGetParam& get_param, common::ObNewScanner& scanner, const int64_t start_time, const int64_t timeout);
        ...
        int new_scan(const common::ObScanParam& scan_param, common::ObNewScanner& scanner, const int64_t start_time, const int64_t timeout);
      ...
      private:
        ...
        int add_to_scanner_(common::ObIterator& ups_merger, ObScanner& scanner,
            int64_t& row_count, const int64_t start_time, const int64_t timeout, const int64_t result_limit_size = UINT64_MAX);
        int add_to_scanner_(common::ObIterator& ups_merger, ObNewScanner& scanner,
            int64_t& row_count, const int64_t start_time, const int64_t timeout, const int64_t result_limit_size = UINT64_MAX);
        int add_to_scanner_(sql::ObMultipleMerge &multiple_merge, ObNewScanner& scanner,
            int64_t& row_count, const int64_t start_time, const int64_t timeout, const int64_t result_limit_size = UINT64_MAX);
      private:
      ...
      private:
        ...
        ObResourcePool<ObRowIterAdaptor> row_iter_adaptor_rp_;
    };
  }
}

...
BuildRequires: t-csrd-tbnet-devel >= 1.0.8 lzo >= 2.06 snappy >= 1.0.2 libaio-devel >= 0.3 t_libeasy-devel >= 1.0.13-186 openssl-devel >= 0.9.8 mysql-devel >= 5.0.77 numactl-devel >= 0.9.8
Requires: lzo >= 2.06 snappy >= 1.0.2 libaio >= 0.3 openssl >= 0.9.8 numactl >= 0.9.8

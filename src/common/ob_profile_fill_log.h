...
{ \
  ...
  {\
    databuff_printf(ObProfileFillLog::get_log_buf(), 1024, pos, "rpc:channel_id=[%ld] latency=[%ld] ", profile_data.rpc_latency_arr_[i].channel_id_, profile_data.rpc_latency_arr_[i].rpc_end_ - profile_data.rpc_latency_arr_[i].rpc_start_);\
  }\

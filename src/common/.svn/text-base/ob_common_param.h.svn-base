...
#define SF_BIT_LOCAL_INDEX_SCAN     1
#define SF_BIT_RESERVED             40
      ...
      static const uint64_t SF_MASK_LOCAL_INDEX_SCAN      = (0x1UL<<SF_BIT_LOCAL_INDEX_SCAN)      - 1;
      ...
      ScanFlag()
        ...
        daily_merge_scan_(0), full_row_scan_(0), rowkey_column_count_(0), 
        local_index_scan_(0), reserved_(0)
      {
      }
      ScanFlag(
          const SyncMode mode, const Direction dir, 
          const bool nop, const bool merge, 
          const bool full, const int64_t count, const int64_t index = 0)
      {
        flag_ = 0;
        ...
        local_index_scan_     = index & SF_MASK_LOCAL_INDEX_SCAN;
        //flag_ |= (mode & 0x3);
        //flag_ |= ((dir & 0x3) << 2);
        //flag_ |= ((nop & 0x1) << 4);
        //flag_ |= ((merge & 0x1) << 5);
      ...
      union
      {
        ...
        struct
        {
          ...
          uint64_t local_index_scan_      : SF_BIT_LOCAL_INDEX_SCAN;

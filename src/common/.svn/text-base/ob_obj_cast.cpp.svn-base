  ...
  namespace common
  {
    ...
    ObObjCastFunc OB_OBJ_CAST[ObMaxType][ObMaxType] =
    {
      ...
      ,
      {
        ...
        datetime_varchar, not_support/*Unknown*/, datetime_ctime,
      ...
      ,
      {
        ...
        pdatetime_varchar, not_support/*Unknown*/,pdatetime_ctime,
      ...
      ,
      {
        ...
        identity, not_support/*Unknown*/, varchar_ctime,
      ...
      ,
      {
        ...
        ctime_varchar, not_support/*Unknown*/, identity,
      ...
      ,
      {
        ...
        mtime_varchar, not_support/*Unknown*/, mtime_ctime,
      ...
      ,
      {
        ...
        bool_varchar, not_support/*Unknown*/, bool_ctime,
      ...
      ,
      {
        ...
        decimal_varchar, not_support/*Unknown*/, decimal_ctime,

 ...
 *
 * Time-stamp: <2013-03-08 14:48:06 fufeng.syd>
 * Version: $Id$
  ...
  namespace rootserver
  {
      ...
      : public common::ObServerConfig
    {
      ...
      public:
        ...
        DEF_INT(tablet_replicas_num, "3", "tablet replicas num");
        ...
        DEF_INT(write_queue_size, "100", "[10,100000]", "write queue size");
        DEF_INT(log_queue_size, "100", "[10,100000]", "log queue size");
        DEF_TIME(network_timeout, "50s", "network timeout for rpc process");
        ...
        DEF_TIME(log_sync_timeout, "500ms", "log sync rpc timeout");
        ...
        DEF_TIME(balance_worker_idle_time, "30s", "balance worker idle wait time");
        ...
        DEF_INT(balance_max_concurrent_migrate_num, "2", "[1,10]", "max concurrent migrate num for balance");
        DEF_INT(balance_max_migrate_out_per_cs, "20", "[1,100]", "max migrate out per cs");
        ...
        DEF_INT(read_master_master_ups_percent, "100", "[0,100]", "master master ups read percent");
        DEF_INT(read_slave_master_ups_percent, "100", "[0,100]", "slave master ups read percent");

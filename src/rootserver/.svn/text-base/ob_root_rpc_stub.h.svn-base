  ...
  namespace rootserver
  {
    class ObRootRpcStub : public common::ObCommonRpcStub
    {
      public:
        ...
        virtual int request_cs_build_sample(const common::ObServer& chunkserver, const int64_t timeout_us,
                const int64_t frozen_version, const uint64_t data_table_id, const uint64_t index_table_id, const int64_t sample_count);
        virtual int request_cs_build_index(const common::ObServer& chunkserver, const int64_t timeout_us,

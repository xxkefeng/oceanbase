  ...
  namespace rootserver
  {
    class ObRootWorker :public common::ObBaseServer, public common::ObPacketQueueHandler
    {
      ...
      private:
        ...
        //index build
        int rt_report_samples(const int32_t version, common::ObDataBuffer& in_buff, 
            easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rt_cs_build_sample_done(const int32_t version, common::ObDataBuffer& in_buff,
            easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int rt_cs_build_index_done(const int32_t version, common::ObDataBuffer& in_buff,
            easy_request_t* req, const uint32_t channel_id, common::ObDataBuffer& out_buff);
        int build_index_done(const int32_t version, common::ObDataBuffer& in_buff,

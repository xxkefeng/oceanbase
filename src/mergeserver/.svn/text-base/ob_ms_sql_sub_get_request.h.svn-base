...
namespace oceanbase
{
  namespace mergeserver
  {
    ...
    public:
      ...
      void set_param(sql::ObSqlGetSimpleParam & get_param);
      ...
      inline int get_cur_param(sql::ObSqlGetSimpleParam & get_param)const
      {
    ...
    private:
      int get_next_param_(sql::ObSqlGetSimpleParam & get_param)const;
      //指向整个大请求的指针
      sql::ObSqlGetSimpleParam *pget_param_;
    ...
    public:
      ...
      int init(SubRequestVector *results, const int64_t res_count, const sql::ObSqlGetSimpleParam & get_param);
    ...
    private:
      ...
      const sql::ObSqlGetSimpleParam            *get_param_;

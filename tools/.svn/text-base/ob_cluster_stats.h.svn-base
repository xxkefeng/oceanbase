...
namespace oceanbase
{
  namespace tools
  {
    ...
    {
      public:
        ObClusterStats(ObClientRpcStub &stub, const common::ObStatMod mod)
          : ObServerStats(stub, mod) { }
    ...
    {
      public:
        ObAppStats(ObClientRpcStub &stub, const common::ObStatMod mod, const char* config_file) ;
        virtual ~ObAppStats() {}
      protected:
        virtual int32_t refresh() ;
      private:
